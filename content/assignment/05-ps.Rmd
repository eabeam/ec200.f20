...
$log(price) = \beta_0 = \beta_1log(nox) + \beta_2rooms + u$ 
  ...
  Is the relationship between the simple and multiple regression estimates of the elasticity of $price$ with respect to $nox$ what you would have predicted, given your answer in part (ii)? Does this mean that 2.718 is definitely closer to the true elasticity than 21.043?
